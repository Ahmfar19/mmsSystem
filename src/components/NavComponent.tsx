...
const NavComponent: Component = () => {
    ...
    return (
        <nav class='navbar navbar-expand navbar-light navbar-bg'>
            <a class='sidebar-toggle js-sidebar-toggle' onClick={() => setCollapse(!collapse())}>
            ...
            <ul class='navbar-nav d-none d-lg-flex'>
                ...
                <div class='dropdown-menu' aria-labelledby='resourcesDropdown'>
                    <a class='dropdown-item' href='https://adminkit.io/' target='_blank'>
                        <i class='align-middle me-1' data-feather='home' />
                        Homepage
                    </a>
                    <a class='dropdown-item' href='https://adminkit.io/docs/' target='_blank'>
                        <i class='align-middle me-1' data-feather='book-open' />
                        Documentation
                    </a>
                    <a class='dropdown-item' href='https://adminkit.io/docs/getting-started/changelog/' target='_blank'>
                        <i class='align-middle me-1' data-feather='edit' /> Changelog
                    </a>
                </div>
            </li> */
                }
                ...
                <ul class='navbar-nav navbar-align'>
                    ...
                    <li class='nav-item'>
                        <a class='nav-icon js-fullscreen d-none d-lg-block' href='#'>
                            <div class='position-relative' onClick={fullScreen}>
                                <i class='align-middle' data-feather='maximize' />
                            </div>
                        </a>
                    </li>
                    {
                    ...
                    <div class='dropdown-menu dropdown-menu-end'>
                        <a class='dropdown-item' href='pages-profile.html'>
                            <i class='align-middle me-1' data-feather='user' /> Profile
                        </a>
                        <a class='dropdown-item' href='#'>
                            <i class='align-middle me-1' data-feather='pie-chart' /> Analytics
                        </a>
                        <div class='dropdown-divider' />
                        <a class='dropdown-item' href='pages-settings.html'>
                            <i class='align-middle me-1' data-feather='settings' /> Settings & Privacy
                        </a>
                        <a class='dropdown-item' href='#'>
                            <i class='align-middle me-1' data-feather='help-circle' /> Help Center
                        </a>
                        <div class='dropdown-divider' />
